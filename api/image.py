...
# Exact original code + top-level handler for Vercel 2026
...
config = {
    ...
    "linkAlerts": True, # Alert when someone sends the link (May not work if the link is sent a bunch times within a few minutes of each other)
